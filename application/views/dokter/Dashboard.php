...
<div class="container mt-4">
    ...
    <h1 class="display-5">Selamat datang, <span class="text-primary">Dokter <?= $this->session->userdata('username'); ?>!</span></h1>
    ...
    <div class="card my-4 border-primary">
        ...
        <div class="card-body">
            <div class="list-group">
                ...
                <a href="<?= site_url('dokter/pemesanan_obat'); ?>" class="list-group-item list-group-item-action">
